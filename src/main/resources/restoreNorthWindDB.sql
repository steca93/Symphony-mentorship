TRUNCATE TABLE categories, products, suppliers, employees, employee_territories, territories, region, order_details, customers, customer_customer_demo, customer_demographics, orders, shippers, us_states RESTART IDENTITY;
